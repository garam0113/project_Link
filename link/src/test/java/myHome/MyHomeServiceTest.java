...
public class MyHomeServiceTest {
	...
	//@Test
    public void updateMyHomeOpenCondition() throws Exception{
		...
		user.setOpenCondition("1");
	
		myHomeService.updateMyHomeOpenCondition(user);
	    User user2 = userService.getUser("user01");
		
		System.out.println("insert 결과 : "+user2);
		
	}
	//@Test
	public void updateMyHomePushCondition() throws Exception{
...
//    @Test
    ...
    System.out.println("followList 출력값 "+list);
	...
	public void getFollowerList() throws Exception{
		...
		List<User> list= (List<User>)map.get("list");
	    System.out.println("followerList 출력값 "+list);
