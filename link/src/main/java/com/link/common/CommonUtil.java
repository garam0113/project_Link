...
public class CommonUtil {
	...
	// String�� null�̰ų� nullString�϶� ������ �Ű����� String���� ����
	...
	// Object�ȿ� �����Ͱ� �����ֶ� nullString���� ��ȯ ==> NumberFormatException ����
	// Object�ȿ� �����Ͱ� String�϶� nullString���� ��ȯ?
	// Object�ȿ� �����Ͱ� null�϶� nullString���� ��ȯ ==> NullPorinterException ����
	...
	// null�̳� nullString�̶�� nullString���� ��ȯ
