			...
			<div id="main">
				...
				<section class="row section">
					<div class="row-content buffer even clear-after">
						...
						<p class="centertxt">I占쏙옙m an experienced and passionate user interface designer with interaction design background.<br>My goal is to make the world wide web a better place by designing beautiful user experiences, one site at a time.</p>
