...
<body>
	...
	<h4 style= "transform: translate(500px, 50px);">고객센터를 통해 궁금증을 해결하세요 <h4>
	
	<img src="/resources/image/uploadFiles/고객센터.JPG" class="image2" width ="400px" height="400px" style= "transform: translate(1020px, -150px);" />
		<br/><br/><br/>
