...
REPORT_CONDITION, DELETE_CONDITION, PARENT, DEPTH, SEQUENCE
FROM CLUB_POST_COMMENT
WHERE CLUB_POST_NO = 20 AND REPORT_CONDITION = '0' AND DELETE_CONDITION = '0'



getCurrentClubPostList()
...
getClubPostListCount()
SELECT COUNT(*) FROM CLUB_POST WHERE CLUB_NO = 10 AND REPORT_CONDITION = '0' AND DELETE_CONDITION = '0'



getClubPostListMySelf()
SELECT * FROM CLUB_POST WHERE USER_ID = 'user02' AND CLUB_NO = 10 AND REPORT_CONDITION = '0' AND DELETE_CONDITION = '0'



getClubPostListMySelfCount()
SELECT COUNT(*) FROM CLUB_POST WHERE USER_ID = 'user02' AND CLUB_NO = 10 AND REPORT_CONDITION = '0' AND DELETE_CONDITION = '0'
