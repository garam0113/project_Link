...
SELECT CP.CLUB_POST_NO, CP.CLUB_NO, CP.USER_ID, U.PROFILE_IMAGE, U.NICKNAME, CP.CLUB_POST_TITLE, CP.CLUB_POST_CONTENT, CP.CLUB_POST_VIDEO1, CP.CLUB_POST_VIDEO2, CP.CLUB_POST_VIDEO3, CP.CLUB_POST_REG_DATE, CP.CLUB_POST_UPDATE_DATE, CP.CLUB_POST_HEART_COUNT, CP.CLUB_POST_COMMENT_COUNT, CP.IMAGE1, CP.IMAGE2, CP.IMAGE3, CP.IMAGE4, CP.IMAGE5, CP.IMAGE6, CP.IMAGE7, CP.IMAGE8, CP.IMAGE9, CP.IMAGE10, HEART_CONDITION, CLUB_ROLE
FROM CLUB_POST CP, USERS U, ( SELECT SOURCE_NO AS HEART_CONDITION
								FROM HEART
								WHERE TRIM(SOURCE) = '2' AND USER_ID = 'user03' ) V1, ( SELECT member_role AS CLUB_ROLE, USER_ID
																					FROM CLUB_USER
																					WHERE USER_ID = 'user03' AND CLUB_NO = 0 ) V2
WHERE CP.USER_ID = U.USER_ID AND HEART_CONDITION (+) = CP.CLUB_POST_NO AND V2.USER_ID (+) = U.USER_ID AND CP.CLUB_POST_NO = 0
